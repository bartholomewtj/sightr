...
// Some harnesses make this concrete: they emit `38;5;1`/`38;5;3`/`38;5;6` and no basic
// codes at all, so a table keyed only on `3xm` would miss their chrome entirely.
