...
// (hooks/use-direct-typing.ts). collie#103 is that nothing on screen connected the two — the refusal
...
// .adr/0017-recognising-a-password-prompt-changes-what-sightr-says.md: a match here is a guess about
...
// there. The same three lines appear under Claude, under grok, and under a bare shell.
 ...
 * it simply falls through to the generic refusal, which is the pre-collie#103 behaviour.
 *
 ...
 * pre-collie#103 behaviour and costs nothing. Unlike everything else in this header, adding locales is
