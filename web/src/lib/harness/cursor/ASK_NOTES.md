...
Observed 2026-09-13 on Cursor Agent in pane `wDX:p9`. Sightr showed user bubble only; Herdr reported status `done`. Terminal displayed the raw box.
...
Source file: `%LOCALAPPDATA%\cursor-agent\versions\2026.09.10-fd3934a\3484.index.js`.
Components:
