...
// archive/.adr/0004-the-statusline-run-is-bounded.md says why: the row count is not what protects that walk
// (the blank line above a dialog's footer is), and a taller blind window admits MORE screens it should refuse.
// So the popup is matched POSITIVELY, by its own shape, and peeled before the walk starts.
//
...
// ("  /home/user/project   main") out of the run.
