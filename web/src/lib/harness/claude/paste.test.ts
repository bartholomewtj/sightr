...
// sightr-demo sandbox; the rejections are the load-bearing half — a `true` here fires the submit key
...
describe("pasteCarriesSend — rejections (the guard stays shut)", () => {
  ...
  it("rejects a tail that stops SHORT of the end of what we sent (collie#110)", () => {
    // THE partial-arrival false positive. Live-probed 2026-08-17 (sightr-demo, pane `w6:p1`): the
