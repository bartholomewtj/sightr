...
//
// Every OTHER agent (pi, a bare shell, or an unknown/absent agent) has an unverified
...
export const claudeAdapter: HarnessAdapter = {
  ...
  // absence is exactly the condition under which typing lands in a modal instead (collie#34's shape).
