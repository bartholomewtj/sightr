...
// The bundled Nerd Font faces are the only webfont Sightr ships, and the design rests on three facts
...
// renamed file is a tofu box again (collie#70); a woff2 back in `globPatterns` charges every install
