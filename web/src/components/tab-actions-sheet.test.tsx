...
// The tab actions sheet (opened from the ⋯ button or right-click) — now STRUCTURALLY IDENTICAL to the pane sheet (the user asked for
...
// Folded from tab-actions-sheet-desktop.test.tsx.
