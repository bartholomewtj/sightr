...
import { FEEDBACK_MAX_LENGTH } from "@/lib/actions";
...
const FEEDBACK_COPY: Record<PromptFeedbackPurpose, { offer: string | null; editorLabel: string; placeholder: string; help: string; send: string; sending: string; focused: string; typedPrefix: string }> = {
  "plan-change": {
    offer: "Tell Claude what to change", editorLabel: "What should Claude change?", placeholder: "Say what to do differently…",
    help: "Sends the plan back with your notes — Claude keeps planning instead of starting work.", send: "Send feedback", sending: "Sending feedback…",
    focused: "The feedback box has the keyboard in the terminal — these buttons would type into it instead of answering. They resume when it closes.",
...
//     and no button on this dialog can fire (collie#95: they used to render as ordinary buttons and
...
//   * TEXT ALREADY IN THE BOX — the options answer normally, but Sightr will not type: re-entering a
