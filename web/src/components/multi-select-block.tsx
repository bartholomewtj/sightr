...
import type { MultiSelectModel, WizardAnswer } from "@/lib/blocks";
...
import { ReviewAnswerList } from "@/components/wizard-block";
...
function ReviewPhase({
  ...
  return (
    <PromptPanel ariaLabel="Ready to submit your answers?">
      {/* Renders no WizardStepper and no nav controls (#371: no Left/Right from the review step). */}
      <ReviewAnswerList answers={answers} />
      {incomplete ? (
