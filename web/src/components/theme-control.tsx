...
// follows the system, which is the situational flip (outdoors, in bed) happening on its own.
      ...
      <div className="flex items-center justify-between gap-4 p-4">
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm text-muted-foreground">Follow the system, or pin one.</p>
          </div>
        </div>
      </div>
