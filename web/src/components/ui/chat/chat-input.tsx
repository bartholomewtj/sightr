...
function ChatInput({ className, ref, ...props }: React.ComponentProps<"textarea">) {
  return (
    <textarea
      ...
      autoCapitalize="none"
      className={cn(
        "field-sizing-content max-h-40 min-h-11 w-full resize-none rounded-md border border-input bg-transparent px-3 py-2.5 text-base shadow-xs outline-none transition-[color,box-shadow] placeholder:text-muted-foreground focus-visible:border-input focus-visible:ring-1 focus-visible:ring-input/50 disabled:cursor-not-allowed disabled:opacity-50",
        className,
      )}
      {...props}
    />
